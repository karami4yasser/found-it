...
export default function SignIn() {
    ...
    const [PhoneNumberEmailHasError, setPhoneNumberEmailHasError] = useState(false);
    ...
    const validatingFields = () => {
        ...
        if (signInForm.emailOrPhone === "") {
            ...
            hasError = true;
        } else if (!isValidPhoneNumber(signInForm.emailOrPhone) && !isValidEmail(signInForm.emailOrPhone)) {
            Toaster.show("Invalid email address or phone number. Please enter a valid email or a 10-digit phone number!", 1500, true, COLORS.red);
            setPhoneNumberEmailHasError(true);
            hasError = true;
        } else {
    ...
    function isValidPhoneNumber(input: string) {
        return (input.length === 10 && Array.from(input).every(c => c <= '9' && c >= '0'))
    }
    ...
    return (
        <View style={SignInStyle.container}>{loading ? (
            ...
            <>
                ...
                <View style={SignInStyle.formContainer}>
                    <InputTextWithPurpleBackground hasError={PhoneNumberEmailHasError} currentValue={signInForm.emailOrPhone} setValue={(value) => setSignInFormItem("emailOrPhone", value)} placeholder="Email or Phone number" type={"default"}
                    />
                ...
                <View style={{ alignItems: 'center', marginBottom: "20%" }}>
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                        ...
                        <TouchableOpacity style={{ paddingVertical: 10 }} onPress={handleNavigateSignUp}>
